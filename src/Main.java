...
public class Main {
    ...
    public static int generateRandomAge() {
        ...
        return random.nextInt(61) + 10; // Генерация случайного возраста от 10 до 70 лет
    }

    public static int generateRandomTemperature() {
        Random random = new Random();
        return random.nextInt(61) - 30; // Генерация случайной температуры от -30 до 30 градусов
    }
}
